...
# tangara_pipeline documentation build
...
from tangara_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "tangara_pipeline"
author = "Kedro"
...
htmlhelp_basename = "tangara_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "tangara_pipeline.tex",
        "tangara_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "tangara_pipeline",
        "Project tangara_pipeline codebase.",
        "Data-Science",
    )
]
