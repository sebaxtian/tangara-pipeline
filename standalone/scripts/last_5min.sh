...
#
# Process data from the last 5 minutes, execute this script every 5 minutes
# to report data from the last 5 minutes since the current datetime.
#

echo "Running Tangara Last 5 Minutes Pipeline ..."

# Define datetime interval to last 5min from now
START_ISO8601_DATETIME=$(TZ='America/Bogota' date --date='5 minutes ago' --iso-8601=seconds)
